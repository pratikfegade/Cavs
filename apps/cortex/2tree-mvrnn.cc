...
// DEFINE_int32(hidden_size, 64, "hidden size");
...
//     Wm = Sym::Variable(DT_FLOAT, {FLAGS_hidden_size * 2 * FLAGS_hidden_size},
// 		       Sym::Uniform(-FLAGS_init_scale, FLAGS_init_scale));
//     Bm = Sym::Variable(DT_FLOAT, {FLAGS_hidden_size * FLAGS_hidden_size}, Sym::Zeros());
//   }
